...
use Nasumilu\UX\Leafletjs\Loader\XmlMapLoader;
...
/**
 * Description of XmlMapLoaderTest
 *
 * @author mlucas
 */
class XmlMapLoaderTest extends TestCase
{
    ...
    public function load(): void
    {
        ...
        $loader = new XmlMapLoader($factory, $locator);
        $map = $loader->load('test_map.xml');
